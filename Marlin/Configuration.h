...
#define STRING_CONFIG_H_AUTHOR "(be-louis, Anycube)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycube"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "df0ae7b5-2b02-4d78-84ad-f9251998d051"
 ...
 */
  ...
  #define ALL_DRIVERS_TYPE TMC2208
#else
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 150, 60 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 300, 60 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26, 0, -1.54 }
